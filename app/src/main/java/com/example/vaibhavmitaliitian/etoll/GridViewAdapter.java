...
public class GridViewAdapter extends ArrayAdapter<AdapterItem> {
    private Context mContext;
    private int resourceId;
    private ArrayList<AdapterItem> data = new ArrayList<>();


    public GridViewAdapter(Context context, int layoutResourceId, ArrayList<AdapterItem> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (itemView == null) {
                ...
                holder = (GridViewAdapter.ViewHolder) itemView.getTag();
            }
